...
MongooseConfigs.init();

/* const model = Message.getMsgModel();
MessageRepo.createMsg(
  new model({ text: "Hello Rebecca", user: "Robert", added: new Date() })
);
MessageRepo.createMsg(
  new model({ text: "Hello Robert", user: "Rebecca", added: new Date() })
); */
